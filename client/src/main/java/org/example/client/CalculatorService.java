 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://example.org/", wsdlLocation = "http://localhost:8888/cal/?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8888/cal/?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://example.org/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example.org/", "CalculatorPort"), Calculator.class, features);
    }
