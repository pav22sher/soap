...
public class ObjectFactory {
    ...
    private final static QName _DivResponse_QNAME = new QName("http://example.org/", "divResponse");
    private final static QName _Add_QNAME = new QName("http://example.org/", "add");
    private final static QName _Div_QNAME = new QName("http://example.org/", "div");
    private final static QName _Sub_QNAME = new QName("http://example.org/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://example.org/", "subResponse");
    private final static QName _AddResponse_QNAME = new QName("http://example.org/", "addResponse");
    private final static QName _MulResponse_QNAME = new QName("http://example.org/", "mulResponse");
    private final static QName _Mul_QNAME = new QName("http://example.org/", "mul");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.org/", name = "divResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.org/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.org/", name = "div")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.org/", name = "sub")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.org/", name = "subResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.org/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.org/", name = "mulResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.org/", name = "mul")
